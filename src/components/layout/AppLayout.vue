...
<template>
  <div class="flex h-dvh overflow-hidden" style="background: var(--bg-base);">
    ...
    <div class="flex-1 flex flex-col overflow-hidden min-w-0">
      <div class="flex items-center gap-2 pr-2 border-b lg:hidden"
      ...
      <main class="flex-1 overflow-y-auto">
        <div class="min-h-full flex flex-col">
          ...
          <footer class="py-4 text-center text-xs" style="color: var(--text-tertiary);">
            MCP Central &mdash; Powered with ❤️ by <a href="https://lagarde-cyber.com" target="_blank"
              rel="noopener noreferrer">LaGarde Cyber</a> &copy; {{ new
