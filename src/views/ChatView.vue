    ...
    <div class="chat-layout">
      <div :class="['chat-sidebar', { 'sidebar-hidden': !sidebarOpen }]">
        <ChatSessionList
          ...
          :active-tenant-id="tenantStore.selectedTenant?.id"
      ...
      <div class="chat-main">
        <div class="chat-topbar">
          <button type="button" class="sidebar-toggle" @click="sidebarOpen = !sidebarOpen" :title="sidebarOpen ? 'Hide sessions' : 'Show sessions'">
        ...
        <div v-if="!isConfigured" class="config-warning">
          ...
          <span>Ollama is not configured. <router-link to="/settings" class="warning-link">Open Settings</router-link> to set up your server URL and model.</span>
        </div>
